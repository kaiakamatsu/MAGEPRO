...
bim, fam, G = read_plink("1KG_HM3_chr1", verbose=False) #Note: we will want to use EUR 1KG and AFR 1KG to simulate this (I only have EUR 1KG plink files...)
G = G.T
bim = np.array(bim)
...
Z_qtl = pd.DataFrame(sim_geno(L,1500)) #simulates 1500 people; change this to what you want. 
