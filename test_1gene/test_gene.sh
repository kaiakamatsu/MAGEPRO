...
Rscript ../ComputeMultiPopWeights.R --gene $gene --tissue Whole_Blood --bfile /expanse/lustre/scratch/kakamatsu/temp_project/GTExTEMP/AFR_Whole_Blood/$gene --covar /expanse/lustre/projects/ddp412/kakamatsu/eQTLsummary/multipopGE/intermedfiles/Covar_All_Whole_Blood.txt --hsq_p 1 --tmp /expanse/lustre/scratch/kakamatsu/temp_project/GTExTEMP/tmp_Whole_Blood/"$gene"_Whole_Blood --out /expanse/lustre/scratch/kakamatsu/temp_project/GTExTEMP/weights_trials/Whole_Blood/Whole_Blood.$gene --PATH_gcta /expanse/lustre/projects/ddp412/kakamatsu/fusion_twas-master/gcta_nr_robust --gemmaout "$gene"_Whole_Blood --PATH_gemma /expanse/lustre/projects/ddp412/kakamatsu/gemma-0.98.5-linux-static-AMD64 --verbose 1 --PATH_plink ../../../../plink --datasets eqtlgen,ota,his,test,mesa,genoa
