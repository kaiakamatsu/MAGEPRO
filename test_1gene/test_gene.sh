...
#tmpdir=$scratch/tmp
tmpdir=/expanse/lustre/projects/ddp412/kakamatsu/MAGEPRO/test_1gene/tmp
wd=$scratch/wd
mkdir $tmpdir
mkdir $wd
plinkdir=$scratch/plink_gene
plink_exec=/expanse/lustre/projects/ddp412/kakamatsu/plink
...
#intermed=/expanse/lustre/projects/ddp412/kakamatsu/GENE_MODELS/MESA_HIS_Monocyte/intermediate
...
TMP=$tmpdir/${gene}
OUT=/expanse/lustre/projects/ddp412/kakamatsu/MAGEPRO/test_1gene/${gene}
cd ../
Rscript MAGEPRO.R --gene $gene --bfile $wd/$gene --covar $intermed/Covar_All.txt --tmp $TMP --out $OUT --PATH_gcta /expanse/lustre/projects/ddp412/kakamatsu/fusion_twas-master/gcta_nr_robust --PATH_plink ${plink_exec} --sumstats_dir /expanse/lustre/projects/ddp412/kakamatsu/SuSiE --sumstats eqtlgen,eurgtex,mesaafr,mesahis --models SINGLE,META,PT,SuSiE,PRSCSx,MAGEPRO_fullsumstats,MAGEPRO --ss 31684,574,233,352 --hsq_p 1 --verbose 2 --ldref_pt /expanse/lustre/projects/ddp412/kakamatsu/GENOTYPES_GE_data/GENOA/GENOTYPES/phg000927.v1.NHLBI_GENOA_GWAS_AA.genotype-calls-matrixfmt.c1/AA_genotypes_combined/maf_hwe_rate_relatedness_HM3_filtered_people_with_GE_inGEU_YRI_redo/GENOA_AA_chr --ldref_PRSCSx /expanse/lustre/projects/ddp412/kakamatsu/eQTLsummary/multipopGE/benchmark/LD_ref --dir_PRSCSx /expanse/lustre/projects/ddp412/kakamatsu/MAGEPRO/BENCHMARK/PRScsx --phi_shrinkage_PRSCSx 1e-7 --pops EUR,EUR,AFR,AMR --ldref_dir /expanse/lustre/projects/ddp412/sgolzari/ldref --ldrefs GTEx_EUR,GTEx_EUR,MESA_AAall,MESA_HISall --out_susie /expanse/lustre/projects/ddp412/kakamatsu/MAGEPRO_susie
#Rscript MAGEPRO.R --gene $gene --bfile $wd/$gene --covar $intermed/Covar_All.txt --tmp $TMP --out $OUT --PATH_gcta /expanse/lustre/projects/ddp412/kakamatsu/fusion_twas-master/gcta_nr_robust --PATH_plink ${plink_exec} --sumstats_dir /expanse/lustre/projects/ddp412/kakamatsu/MAGEPRO_susie --sumstats eqtlgen,eurgtex,mesaafr,mesahis --models SINGLE,META,SuSiE,MAGEPRO_fullsumstats,MAGEPRO --ss 31684,574,233,352 --hsq_p 1 --verbose 2 --ldref_pt /expanse/lustre/projects/ddp412/kakamatsu/GENOTYPES_GE_data/GENOA/GENOTYPES/phg000927.v1.NHLBI_GENOA_GWAS_AA.genotype-calls-matrixfmt.c1/AA_genotypes_combined/maf_hwe_rate_relatedness_HM3_filtered_people_with_GE_inGEU_YRI_redo/GENOA_AA_chr --ldref_PRSCSx /expanse/lustre/projects/ddp412/kakamatsu/eQTLsummary/multipopGE/benchmark/LD_ref --dir_PRSCSx /expanse/lustre/projects/ddp412/kakamatsu/MAGEPRO/BENCHMARK/PRScsx --phi_shrinkage_PRSCSx 1e-7 --pops EUR,EUR,AFR,AMR --skip_susie TRUE
rm $wd/$gene.* 
