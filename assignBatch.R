...
#allgenenames <- fread("/expanse/lustre/projects/ddp412/kakamatsu/eQTLsummary/multipopGE/intermedfiles/genes_assign_Whole_Blood.txt", select = c(1), header = FALSE)
...
write.table(x, file = paste0("/expanse/lustre/projects/ddp412/kakamatsu/eQTLsummary/multipopGE/intermedfiles/genes_assign_",tissues[i],"2.txt"), row.names = F, col.names = F, sep = "\t", quote= F) 
}
