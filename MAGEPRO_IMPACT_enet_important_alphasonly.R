...
total_ss_cv <- total_ss_sumstats # we don't include the target betas into meta-analysis (just meta-analyze eQTL weights)
}
...
total_ss_full <- total_ss_sumstats
...
eqfull <- matrix(0, nrow = N.tot, ncol = ext2)
#eqfull[, 1] <- w1
#num = 2
num = 1
for (w in wgt2){	
