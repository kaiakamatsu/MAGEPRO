...
#SBATCH --mem=2G
#SBATCH -t 04:00:00
#SBATCH -J MAGEPRO_functional
#SBATCH -A ddp412
#SBATCH -o ../working_err/MAGEPRO_functional.%j.%N.out
#SBATCH -e ../working_err/MAGEPRO_functional.%j.%N.err
#SBATCH --export=ALL
