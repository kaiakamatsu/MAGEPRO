...
file <- paste0("/expanse/lustre/scratch/kakamatsu/temp_project/GTExTEMP/weights_benchmark/",tissues[i],"/",tissues[i],".",genes[j],".wgt.RDat") 
...
write.table(r2_h2, file = "benchmark_results.txt", row.names = F, col.names = T, sep = "\t", quote = F)
}
