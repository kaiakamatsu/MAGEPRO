...
magepro_matrix <- diag(ncol(genos$bed))
	# we are simply trying to compare plink lasso to glmnet lasso 
...
save( snps, cv.performance, hsq, hsq.pv, N.tot , wgtmagepro, avg_training_r2_single, avg_training_r2_meta, avg_training_r2_magepro, var_cov, avg_cor, SINGLE_top1, file = paste( opt$out , ".wgt.RDat" , sep='' ) )
