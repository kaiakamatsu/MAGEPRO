...
| --num_covar | Number of covariate to use (number of rows to extract from --covar file). Default assumes gtex covariate file (first 5 PC, first 5 inferredcov, pcr, platform, sex). |
